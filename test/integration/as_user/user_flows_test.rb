...
class UserFlowsTest < ActionDispatch::IntegrationTest
  test "create user and browe home and finally signout and signin again" do
    ...
    post_via_redirect "/as_user/users", user: {email: "dummy@domain.com", name: "dummy", password: "dummy", password_confirmation: "dummy"}
    loged_in_path = path
    ...
    post_via_redirect "/as_user/sessions", session: {email: "dummy@domain.com", password: "dummy"}
    assert_equal loged_in_path, path
